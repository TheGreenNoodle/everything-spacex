const data = [
  ...
  {
    "title": "Faster Global Transport",
    "text": "Imagine being able to travel halfway across the world in under an hour. This may soon be possible with the help of Starship. The idea is that Starship will be able to hold 1000 people. These people would be taken to a sea launch port. Then the rocket will fly up to low Earth orbit. The starship will then reenter the Earth's atmosphere. It will then whip its tail end around and land on another seaport. Ticket prices are expected to be around first-class plane tickets."
  },
  {
